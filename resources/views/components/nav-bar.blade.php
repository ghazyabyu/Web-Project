...
<body>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
         <x-mobile-nav-link href="/home" :active="request()->is('home')">Home</x-mobile-nav-link>
         <x-mobile-nav-link href="/profil" :active="request()->is('profil')">profil</x-mobile-nav-link>
         <x-mobile-nav-link href="/kontak" :active="request()->is('kontak')">kontak</x-mobile-nav-link>
